...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { country_id: @state.country_id, name: @state.name, two_letter_code: @state.two_letter_code } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { country_id: @state.country_id, name: @state.name, two_letter_code: @state.two_letter_code } }
