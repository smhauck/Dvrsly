...
class CountriesTest < ApplicationSystemTestCase
  ...
  test "creating a Country" do
    ...
    fill_in "Global area", with: @country.global_area_id
    fill_in "Name", with: @country.name
    fill_in "Three letter code", with: @country.three_letter_code
    fill_in "Two letter code", with: @country.two_letter_code
